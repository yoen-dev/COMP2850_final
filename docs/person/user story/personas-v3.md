...
> - v2 — Week 6: Goals updated to reflect new features identified during frontend development
...
- Implement allergen filtering so users can exclude recipes containing specific ingredients they cannot eat.
- Implement recipe tag filtering so users can browse by category such as Vegan, Quick, or High Protein to find meals that match their needs.
